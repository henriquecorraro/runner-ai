...
Ecosystem: ll-ds
Task: audit-skeleton
Title: Audit Skeleton for DS migration eligibility
...
### audit-skeleton
Task id: audit-skeleton
Task title: Audit Skeleton for DS migration eligibility
Task status: open
...
Analyze `platform-front/src/components/Skeleton` and determine if it is a generic, reusable UI component suitable for the design-system package, or a domain-specific component that must stay in platform-front.
...
| Pure presentational / loading placeholder | ✅ | ❌ |
| Reusable across multiple apps | ✅ | ❌ |
| Already has equivalent in DS | ❌ (skip) | — |

## Steps

1. Read all files in `platform-front/src/components/Skeleton/`
...
/home/rick/projetos/ecosystem-ai-runner/ecosystems/ll-ds/runs/kiro-1781440390600-j23kex/19-audit-skeleton/output.md
