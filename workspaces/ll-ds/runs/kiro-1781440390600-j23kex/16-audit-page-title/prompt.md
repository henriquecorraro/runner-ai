...
Title: Audit PageTitle for DS migration eligibility
...
### audit-page-title
Task id: audit-page-title
Task title: Audit PageTitle for DS migration eligibility
Task status: open
...
Analyze `platform-front/src/components/PageTitle` and determine if it is a generic, reusable UI component suitable for the design-system package, or a domain-specific component that must stay in platform-front.
...
| Pure presentational / typography | ✅ | ❌ |
| Reusable across multiple apps | ✅ | ❌ |
| Already has equivalent in DS | ❌ (skip) | — |

## Steps

1. Read all files in `platform-front/src/components/PageTitle/`
2. Check imports — flag any app-specific dependencies (stores, services, API clients, app routes)
3. Check if design-system already exports an equivalent component (DS has `Text`)
...
/home/rick/projetos/ecosystem-ai-runner/ecosystems/ll-ds/runs/kiro-1781440390600-j23kex/16-audit-page-title/output.md
