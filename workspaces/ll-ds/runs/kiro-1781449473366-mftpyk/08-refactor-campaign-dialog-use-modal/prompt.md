...
### refactor-campaign-dialog-use-modal
Task id: refactor-campaign-dialog-use-modal
Task title: Refactor CampaignDialog to use useModal hook
Task status: open
Task scope: ds-usemodal-refactor
Task validation: npm run build passes ; No trigger/open/onOpenChange props ; useModal('campaign-dialog') used in component and call sites
...
/home/rick/projetos/ecosystem-ai-runner/ecosystems/ll-ds/runs/kiro-1781449473366-mftpyk/08-refactor-campaign-dialog-use-modal/output.md
